...
<video poster="/src/screencast/installer.png" preload autoplay controls className="screencast">
  <source type="video/mp4" src="/src/screencast/installer.mp4"></source>
</video>
...
<video poster="/src/screencast/installer.png" preload autoplay controls className="screencast">
  <source type="video/mp4" src="/src/screencast/smoke-pro-docker-compose.mp4"></source>
</video>

## Running in Kubernetes

<video poster="/src/screencast/installer.png" preload autoplay controls className="screencast">
  <source type="video/mp4" src="/src/screencast/smoke-cronjob.mp4"></source>
</video>

## Dashboards with results

<video poster="/src/screencast/kibana-smoke-pro.png" preload autoplay controls className="screencast">
  <source type="video/mp4" src="/src/screencast/kibana-smoke-pro.mp4"></source>
</video>
