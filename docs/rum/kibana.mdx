---
sidebar_position: 5
description: Kibana serves as the view layer for Elasticsearch. Thanks to Kibana, you can observe and analyze data that the RUM Server has saved into Elasticsearch.
title: Kibana
tags:
  - rum
  - elasticsearch
