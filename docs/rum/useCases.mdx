...
For successful loading of the page, your e-shop needs resources such as images, CSS, JavaScript, and third-party scripts. The faster the resources load, the quicker your e-shop will load, providing a better user experience.

Jaké zdroje se načítají?
![Most referer](./assets/kibana-resources-graph.png)

Kolik zdrojů stránka spotřebuje
	- `view.usedMemory`
...
Jaké zařízení a prohlížeče uživatelé používají
...
- Jaké typy zdrojů webová stránka načetla
	- `view.resourceTypes`
