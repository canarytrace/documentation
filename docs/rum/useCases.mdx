...
![Most referer](./assets/kibana-referer.png)
...
![User duration](./assets/kibana-user-duration.png)
...
![User actions](./assets/kibana-actions-graph.png)
...
![Kibana find resources](./assets/kibana-find-resources.png)
...
![Most referer](./assets/kibana-resources-graph.png)
...
![Used resources](./assets/kbana-memory-used.png)
...
![Errors](./assets/kibana-errors.png)
...
![Devices and browsers](./assets/kibana-devices-browsers.png)

- Kolik uživatelů právě teď stránku používá

![Session](./assets/kibana-sessions.png)
	- Vypište všechny unikátní `session.id`, které nemají `session.lastLoop` starší několika minut. Například dvě minuty.

  
- Jak rychlý byl backend vs frontend?
	- document: `metrics.ttfb` a `metrics.fp` popřípadě `metrics.fcp`
	- resources: `view.resources`
- Jaké má zařízení, model, výkon (CPU  & RAM) a typ sítě
...
- Který ze zdrojů je blokujících a které to jsou.
