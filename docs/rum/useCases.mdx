...
If you have more information, you will know more important information about your e-shop and satisfaction of your users. Now you can add e.g. [HeroElements](./rumClient#heroelements), [Actions](./rumClient#actions) and [Events](./rumClient#events).

Why?
- je potreba pridat kliknuti, protoze to vyvola reakci vaseho e-shopu a muzeme tak sledovat, jak se vas e-shop chova na zarizeni uzivatele
