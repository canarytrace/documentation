...
![FPS](./assets/kibana-inp-mobile.webp)

You can compare with the desktop device type.

![FPS](./assets/kibana-inp-desktop.webp)
...
![FPS](./assets/kibana-inp-device-type.webp)
...
Na jakých stránkách se uživatel pohyboval
	- `view.href`, `view.id`
