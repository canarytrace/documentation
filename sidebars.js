...
module.exports = {
  docs: {
    ...
    Guides: ['guides/overview', 'guides/architecture', 'guides/elasticsearch', 'guides/cli', 'guides/lifecycle', 'guides/kubernetes','guides/macos', 'guides/linux', 'guides/windows'],
