    ...
    <Layout
      ...
      <main>
        <div id="contact us">
          ...
          <form action="https://canarytrace.us7.list-manage.com/subscribe/post?u=0d360a761b492b97cd84da039&amp;id=04902e6668" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
              <div id="mc_embed_signup_scroll">
            <label for="mce-EMAIL">Send news to my inbox</label>
            <input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="email address" required />
              <div style={{position: 'absolute', left: '-5000px'}} aria-hidden="true"><input type="text" name="b_0d360a761b492b97cd84da039_04902e6668" tabindex="-1" value="" /></div>
