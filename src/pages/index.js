  ...
  return (
    <header className="bg-slate-white dark:bg-[#21222b]">
      <div className="container mx-auto text-center py-24">
        ...
        <p className="text-2xl py-6 text-[#535569] dark:text-slate-50 dark:text-[#b2b5d0]">With Canartrace, you can easily protect your web business, <br/>increase sales and make your customers happier.</p>
      </div>
    </header>
  );
}
