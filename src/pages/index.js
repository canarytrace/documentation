  ...
  return (
    <header className="bg-slate-white dark:bg-[#21222b]">
      <div className="container mx-auto text-center py-24">
        <h1 className="text-[#333333] dark:text-slate-50 text-5xl font-sans font-semibold antialiased">
          Guardians of your 
        ...
        <p className="text-2xl py-6 text-[#b2b5d0] dark:text-slate-50 ">With Canartrace, you can easily protect your web business, <br/>increase sales and make your customers happier.</p>
      </div>
    </header>
  );
}
